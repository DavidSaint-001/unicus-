...
const DataAnalysisDetails = () => {
  ...
  const course = {
    title: "Data Analysis",
    description: "Master data modeling, visualization, and business intelligence tools to transform raw data into actionable insights.",
    duration: "3 Months",
    level: "Intermediate",
    price: "₦110,000",
    image: data,
    ...
    curriculum: [
      { module: "Month 1", title: "Data Analysis Foundations", topics: ["Excel Mastery", "Data Cleaning", "Pivot Tables", "Statistical Basics"] },
      { module: "Month 2", title: "SQL & Database", topics: ["SQL Queries", "Database Design", "Data Aggregation", "Join Operations"] },
      { module: "Month 3", title: "Visualization & BI", topics: ["Tableau Dashboard", "Power BI", "Data Storytelling", "Final Project"] }
    ],
    instructor: {
      name: "Lisa Martinez",
      title: "Data Analyst",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">300+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Become a data-driven decision maker.</p>
