...
const VideoEditingDetails = () => {
  ...
  const course = {
    title: "Video Editing",
    description: "Master professional video editing techniques using Adobe Premiere Pro and After Effects to create compelling visual content.",
    duration: "3 Months",
    ...
    curriculum: [
      { module: "Month 1", title: "Premiere Pro Basics", topics: ["Interface Overview", "Timeline Editing", "Transitions", "Text & Titles"] },
      { module: "Month 2", title: "Advanced Editing", topics: ["Color Correction", "Audio Editing", "Keyframing", "Export Settings"] },
      { module: "Month 3", title: "Motion Graphics & Effects", topics: ["After Effects Basics", "Lower Thirds", "Green Screen", "Final Project"] }
    ],
    instructor: {
      name: "Kevin Brown",
      title: "Video Editor",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">220+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Create professional videos.</p>
