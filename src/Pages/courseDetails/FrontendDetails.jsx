...
const FrontendDetails = () => {
  ...
  const course = {
    ...
    description: "Master modern web development with our comprehensive front-end course. Learn to build responsive, interactive websites using the latest technologies including HTML5, CSS3, JavaScript, and React.",
    duration: "6 Months",
    ...
    curriculum: [
      { module: "Month 1", title: "HTML & CSS Fundamentals", topics: ["HTML5 Semantic Elements", "CSS3 Styling", "Flexbox & Grid", "Responsive Layouts"] },
      { module: "Month 2", title: "JavaScript Core", topics: ["Variables & Functions", "DOM Manipulation", "Events & Effects", "Async JavaScript"] },
      { module: "Month 3", title: "Advanced JavaScript", topics: ["ES6+ Features", "Object-Oriented JS", "API Integration", "JSON Handling"] },
      { module: "Month 4", title: "React.js Foundation", topics: ["Components & Props", "State Management", "Hooks & Lifecycle", "Event Handling"] },
      { module: "Month 5", title: "React.js Advanced", topics: ["Context API", "React Router", "Redux Basics", "Custom Hooks"] },
      { module: "Month 6", title: "Final Project", topics: ["Portfolio Website", "React Application", "Deployment", "Best Practices"] }
    ],
    instructor: {
      name: "Sarah Johnson",
  ...
  const handleRegisterClick = () => {
    if (!isLoggedIn) {
      // Redirect to sign in with course data
      navigate("/signin", { 
        state: { 
      ...
      // Go directly to course registration
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">
                Join our cohort and start your journey to becoming a professional front-end developer.
              </p>
              <button
