...
const DigitalMarketingDetails = () => {
  ...
  const course = {
    ...
    description: "Learn comprehensive digital marketing strategies including SEO, paid advertising, social media marketing, and content marketing to grow businesses online.",
    duration: "4 Months",
    ...
    curriculum: [
      { module: "Month 1", title: "Digital Marketing Fundamentals", topics: ["Marketing Fundamentals", "Target Audience Research", "Competitor Analysis", "Brand Positioning"] },
      { module: "Month 2", title: "SEO & Content Marketing", topics: ["On-Page SEO", "Off-Page SEO", "Content Strategy", "Blog & Article Writing"] },
      { module: "Month 3", title: "Paid Advertising", topics: ["Google Ads Setup", "Facebook Ads Manager", "Campaign Optimization", "Budget Management"] },
      { module: "Month 4", title: "Social Media & Analytics", topics: ["Social Media Strategy", "Instagram & LinkedIn Marketing", "Google Analytics", "Final Project"] }
    ],
    instructor: {
      name: "Michael Chen",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">400+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Join our cohort and start your digital marketing career.</p>
