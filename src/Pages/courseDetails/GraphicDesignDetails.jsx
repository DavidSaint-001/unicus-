...
const GraphicDesignDetails = () => {
  ...
  const course = {
    ...
    description: "Master visual design principles, typography, and industry-standard tools like Adobe Creative Suite to create stunning designs.",
    duration: "4 Months",
    ...
    curriculum: [
      { module: "Month 1", title: "Design Fundamentals", topics: ["Color Theory", "Typography Basics", "Composition", "Design Principles"] },
      { module: "Month 2", title: "Adobe Photoshop", topics: ["Photo Editing", "Retouching", "Digital Painting", "Layer Styles"] },
      { module: "Month 3", title: "Adobe Illustrator", topics: ["Vector Graphics", "Logo Design", "Icons & Illustrations", "Print Preparation"] },
      { module: "Month 4", title: "Brand & Portfolio", topics: ["Brand Identity", "Client Projects", "Portfolio Creation", "Freelance Basics"] }
    ],
    instructor: {
      name: "Maria Santos",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">320+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Start your creative design career.</p>
