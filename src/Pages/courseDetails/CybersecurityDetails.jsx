...
const CybersecurityDetails = () => {
  ...
  const course = {
    title: "Cybersecurity",
    description: "Learn network protection, ethical hacking, and security systems to defend against cyber threats and secure digital infrastructure.",
    duration: "9 Months",
    level: "Advanced",
    price: "₦180,000",
    image: cyber,
    ...
    curriculum: [
      { module: "Months 1-2", title: "Security Foundations", topics: ["Networking Basics", "OS Security", "Firewalls", "VPNs"] },
      { module: "Months 3-4", title: "Ethical Hacking", topics: ["Reconnaissance", "Vulnerability Assessment", "Exploitation", "Reporting"] },
      { module: "Months 5-6", title: "Advanced Security", topics: ["Malware Analysis", "Reverse Engineering", "Web Application Security", "Cloud Security"] },
      { module: "Months 7-8", title: "Operations & Response", topics: ["SIEM Tools", "Incident Response", "Forensics", "Threat Hunting"] },
      { module: "Month 9", title: "Capstone Project", topics: ["Security Assessment", "CTF Competition", "Final Exam", "Certification Prep"] }
    ],
    instructor: {
      name: "James Wilson",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">200+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Become a cybersecurity professional.</p>
