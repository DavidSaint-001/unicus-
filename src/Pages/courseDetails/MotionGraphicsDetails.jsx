...
const MotionGraphicsDetails = () => {
  const navigate = useNavigate();
  
  const course = {
    title: "Motion Graphics & Animation",
    description: "Master professional animation and visual storytelling techniques using industry-standard tools to create captivating motion graphics.",
    duration: "3 Months",
    level: "Intermediate",
    price: "₦100,000",
    image: mgraphics,
    ...
    curriculum: [
      { module: "Month 1", title: "Motion Graphics Basics", topics: ["After Effects Interface", "Keyframe Animation", "Easing & Timing", "Layer Management"] },
      { module: "Month 2", title: "Advanced Animation", topics: ["Expressions & Scripts", "Shape Layers", "Masking Techniques", "Green Screen"] },
      { module: "Month 3", title: "Professional Projects", topics: ["Logo Animation", "Commercial Projects", "Social Media Content", "Final Portfolio"] }
    ],
    instructor: {
      name: "Emma Williams",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">250+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Create stunning motion graphics for brands.</p>
...
export default MotionGraphicsDetails;
