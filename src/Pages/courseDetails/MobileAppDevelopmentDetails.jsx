...
const MobileAppDevelopmentDetails = () => {
  ...
  const course = {
    ...
    description: "Master cross-platform mobile app development using modern frameworks like React Native to build iOS and Android applications.",
    duration: "5 Months",
    level: "Intermediate",
    price: "₦140,000",
    image: app,
    ...
    curriculum: [
      { module: "Month 1", title: "Mobile Development Basics", topics: ["JavaScript Fundamentals", "React Native Setup", "Components & Props", "State & Lifecycle"] },
      { module: "Month 2", title: "Advanced React Native", topics: ["Navigation", "Redux/Context", "Forms & Validation", "Storage"] },
      { module: "Month 3", title: "Backend Integration", topics: ["REST APIs", "Authentication", "Firebase", "Push Notifications"] },
      { module: "Month 4", title: "Native Features", topics: ["Camera & Location", "Maps Integration", "Device APIs", "Animations"] },
      { module: "Month 5", title: "Deployment & Projects", topics: ["App Store Submission", "Google Play", "Testing", "Final Project"] }
    ],
    instructor: {
      name: "Alex Thompson",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">280+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Build mobile apps for iOS and Android.</p>
