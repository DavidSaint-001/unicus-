...
const ComputerAppreciationDetails = () => {
  const navigate = useNavigate();
  
  const course = {
    title: "Computer Appreciation",
    description: "Learn computer fundamentals, basic operations, and essential digital literacy skills to navigate the modern digital world.",
    duration: "2 Months",
    level: "Beginner",
    price: "₦50,000",
    image: computer,
    path: "computer-appreciation",
    highlights: [
      "Computer Basics",
    ...
    curriculum: [
      { module: "Month 1", title: "Computer Fundamentals", topics: ["Hardware Basics", "Software Understanding", "Operating Systems", "Peripherals"] },
      { module: "Month 2", title: "Productivity Tools", topics: ["Word Processing", "Spreadsheets", "Presentations", "Internet Skills"] }
    ],
    instructor: {
      name: "Patricia White",
      title: "IT Trainer",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">150+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Build essential computer skills.</p>
...
export default ComputerAppreciationDetails;
