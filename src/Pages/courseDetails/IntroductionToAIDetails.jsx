...
const IntroductionToAIDetails = () => {
  const navigate = useNavigate();
  
  const course = {
    title: "Introduction to AI",
    description: "Explore the fundamentals of Artificial Intelligence, machine learning, and how AI is transforming industries worldwide.",
    duration: "3 Months",
    level: "Beginner",
    price: "₦120,000",
    image: ai,
    path: "introduction-to-ai",
    highlights: [
      "AI Fundamentals",
    ...
    curriculum: [
      { module: "Month 1", title: "AI Introduction", topics: ["What is AI?", "History of AI", "Types of AI", "AI in Real World"] },
      { module: "Month 2", title: "Machine Learning", topics: ["Supervised Learning", "Unsupervised Learning", "Model Training", "Python for ML"] },
      { module: "Month 3", title: "AI Projects", topics: ["Chatbots", "Image Recognition", "AI Ethics", "Final Project"] }
    ],
    instructor: {
      name: "Dr. John Smith",
      title: "AI Researcher",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">380+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Start your AI journey today.</p>
...
export default IntroductionToAIDetails;
