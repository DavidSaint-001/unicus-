...
const PythonProgrammingDetails = () => {
  const navigate = useNavigate();
  
  const course = {
    title: "Python Programming",
    description: "Master automation, backend development, and data handling with Python. Build real-world applications and scripts.",
    duration: "4 Months",
    ...
    curriculum: [
      { module: "Month 1", title: "Python Basics", topics: ["Variables & Data Types", "Control Flow", "Functions", "File Handling"] },
      { module: "Month 2", title: "Advanced Python", topics: ["OOP Concepts", "Decorators & Generators", "Error Handling", "Modules & Packages"] },
      { module: "Month 3", title: "Web Development", topics: ["Django Framework", "URL Routing", "Database Integration", "Authentication"] },
      { module: "Month 4", title: "Projects & Deployment", topics: ["REST APIs", "Automation Scripts", "Deployment", "Final Project"] }
    ],
    instructor: {
      name: "Robert Taylor",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">450+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Start your Python programming journey.</p>
...
export default PythonProgrammingDetails;
