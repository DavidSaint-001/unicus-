...
const ProjectManagementDetails = () => {
  ...
  const course = {
    ...
    description: "Master Agile frameworks, leadership systems, and execution strategy to deliver successful projects on time and within budget.",
    duration: "5 Months",
    level: "All Levels",
    price: "₦130,000",
    image: project,
    ...
    curriculum: [
      { module: "Month 1", title: "Project Management Fundamentals", topics: ["Project Lifecycle", "Scope Management", "Time Management", "Cost Management"] },
      { module: "Month 2", title: "Agile & Scrum", topics: ["Agile Principles", "Sprint Planning", "Daily Standups", "Retrospectives"] },
      { module: "Month 3", title: "Leadership & Communication", topics: ["Team Dynamics", "Conflict Resolution", "Stakeholder Communication", "Negotiation Skills"] },
      { module: "Month 4", title: "Risk & Quality Management", topics: ["Risk Identification", "Mitigation Strategies", "Quality Assurance", "Change Management"] },
      { module: "Month 5", title: "Certification & Final Project", topics: ["PMP Overview", "Exam Prep", "Capstone Project", "Career Guidance"] }
    ],
    instructor: {
      name: "David Anderson",
      title: "PMP Certified Manager",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div><p className="text-sm text-slate-500">Students</p><p className="font-semibold text-slate-900">350+</p></div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
              ...
              <p className="text-slate-600 mb-6">Become a certified project manager.</p>
