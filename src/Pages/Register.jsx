...
const Register = () => {
  ...
  // Get the return URL if any (for course registration redirect)
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // Store user data (in real app, this would be handled by auth provider)
      ...
      // Redirect to course registration or home after brief delay
      setTimeout(() => {
        if (courseName) {
          navigate(`/course-register`, { 
            state: { courseName, from: location.pathname } 
          });
        } else {
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-600 text-white py-3 rounded-xl font-semibold hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed mt-2"
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-slate-200 py-3 rounded-xl font-medium text-slate-700 hover:bg-slate-50 transition"
            >
